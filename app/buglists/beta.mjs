...
export function init($container, usesComponents) {
    ...
    BugList.append({
        ...
        $container: $container,
        title: `${beta.version} (Beta) Functional Open Blockers`,
        description:
    ...
    BugList.append({
        ...
        $container: $container,
        title: `${beta.version} (Beta) Unfixed New Regressions`,
        description:
            "Bugs with all of the following:\n" +
            "- regression keyword\n" +
            "- status-firefox-" +
    ...
    BugList.append({
        ...
        $container: $container,
        title: `${beta.version} (Beta) Open Carryover Regressions`,
        description:
            "Bugs with all of the following:\n" +
            "- regression keyword\n" +
            "- status-firefox-" +
    ...
    BugList.append({
        ...
        $container: $container,
        title: `${beta.version} (Beta) Severe Carryover Regressions`,
        description:
            "Bugs with all of the following:\n" +
            "- regression keyword\n" +
    ...
    BugList.append({
        ...
        $container: $container,
        title: `${beta.version} (Beta) New Top Crashers`,
        description:
            "Bugs with all of the following:\n" +
    ...
    BugList.append({
        ...
        $container: $container,
        title: `${beta.version} (Beta) Tracked Crashers`,
        description:
            "Bugs with all of the following:\n" +
            "- topcrash keyword\n" +
            "- status-firefox-" +
    ...
    BugList.append({
        ...
        $container: $container,
        title: `${beta.version} (Beta) Performance Bugs Affecting Beta`,
        description:
            "Bugs with all of the following:\n" +
    ...
    BugList.append({
        ...
        $container: $container,
        title: `${beta.version} (Beta) Sec-High/Sec-Crit Affecting Beta`,
        description:
            "Bugs with all of the following:\n" +
